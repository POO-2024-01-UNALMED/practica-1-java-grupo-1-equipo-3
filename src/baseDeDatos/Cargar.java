/**
 * Este módulo pertenece al paquete 'baseDatos' y contiene la clase 'Cargar'.
 * Proporciona la funcionalidad para cargar los datos por defecto y deserializar objetos desde archivos.
 * 
 * Incluye métodos para cargar datos específicos como facturas, tiendas, fábrica, catálogo, clientes, vendedores, 
...
/**
 * La clase 'Cargar' gestiona la carga de datos por defecto y la deserialización de objetos desde archivos.
 */
...
public class Cargar {
    ...
    /**
     * Carga los datos por defecto para los objetos utilizados en la aplicación.
     */
    ...
    /**
     * Guarda los datos serializados en los archivos correspondientes.
     */
    ...
    /**
     * Carga los datos deserializados desde los archivos correspondientes.
     */
