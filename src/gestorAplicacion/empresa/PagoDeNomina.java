/**
 * Este módulo pertenece al paquete 'uiMain' y contiene la clase 'PagoDeNomina'.
 * 
 * Proporciona la funcionalidad para gestionar el pago de nómina a los trabajadores de la empresa.
 * 
 ...
 */
 ...
 /**
  * La clase 'PagoDeNomina' gestiona el proceso de pago de nómina a los trabajadores de la empresa.
  * 
  * Proporciona métodos para seleccionar el tipo de trabajador, calcular los pagos y bonificaciones, y realizar los pagos.
  */
             ...
             while (verificador3) {
                 ...
                 while (verificador2) {
                     ...
                     if (opcTrabajador <= 0 || opcTrabajador > listaTrabajadores.size()) {
                         ...
                         System.out.println("\nAl trabajador " + trabajadorEscogido.getNombre() + " se le pagará " + total
