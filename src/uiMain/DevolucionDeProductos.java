/**
 * Este módulo pertenece al paquete 'uiMain' y contiene la clase 'DevolucionDeProductos'.
 * 
 * Proporciona la funcionalidad para gestionar las devoluciones de productos de las facturas.
 * 
...
/**
  * La clase 'DevolucionDeProductos' gestiona las devoluciones de productos de las facturas.
  * 
  * Proporciona un método principal que guía al usuario a través del proceso de seleccionar una factura,
  * seleccionar un producto, y realizar la devolución del producto.
  */
 
public class DevolucionDeProductos {
    @SuppressWarnings("resource") //Para poder generar el archivo .jar
